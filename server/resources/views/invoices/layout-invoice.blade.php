...
<head>
    ...
    <title>@yield('invoiceType', 'Invoice') {{ $invoice_number ?? 'INV-000017' }}</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <style>
        @yield('accent_vars', ':root { --accent:#2563eb; --accent-dark:#1e3a8a; --accent-light:#eff6ff; --accent-soft:#dbeafe; }')
        :root {
            --text-dark: #111827;
            --text-muted: #6b7280;
            --text-light: #9ca3af;
...
<body>
    ...
    <div class="no-print-bar">
        <div>
            <strong style="font-size: 0.95rem; color: #111827;">@yield('invoiceType', 'Invoice') - {{ $invoice_number ?? 'INV-000017' }}</strong>
    ...
    <div class="invoice-card">
        <div class="top-banner">
            ...
            <div style="text-align: center;">
                <div class="banner-title">@yield('bannerTitle', 'INVOICE')</div>
