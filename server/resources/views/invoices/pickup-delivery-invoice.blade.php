...
<head>
    ...
    <title>Pickup &amp; Delivery Invoice {{ $invoice_number ?? 'INV-000017' }}</title>
...
<body>
    ...
    <div class="no-print-bar">
        <div>
            <strong style="font-size: 0.95rem; color: #111827;">Pickup &amp; Delivery Invoice - {{ $invoice_number ?? 'INV-000017' }}</strong>
    ...
    <div class="invoice-card">
        <div class="top-banner">
            ...
            <div style="text-align: center;">
                <div class="banner-title">PICKUP &amp; DELIVERY INVOICE</div>
