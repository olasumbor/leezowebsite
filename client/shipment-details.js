...
if (downloadInvoiceButton) {
    downloadInvoiceButton.addEventListener("click", async function () {
        ...
        try {
            const response = await fetch(`${CONFIG.API_URL}/shipments/${shipmentId}/invoice`, {
                method: 'GET',
                headers: {
            ...
            link.href = url;
            link.download = `Shipment_${shipmentId}_Invoice.pdf`;
            ...
            button.disabled = !shipment?.invoiceGenerated;
